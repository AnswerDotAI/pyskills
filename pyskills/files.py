...
# %% auto #0
__all__ = ['file_view', 'file_create', 'find_files', 'find_gitignore', 'grep_files']
...
# %% ../nbs/01_files.ipynb #3ecc0ab7
def find_files(
    path:Path|str='.', file_glob:str=None, file_re:str=None, folder_re:str=None,
    skip_file_glob:str=None, skip_file_re:str=None, skip_folder_re:str=None,
    maxdepth:int=None, symlinks:bool=True, ret_folders:bool=False, sort:bool=True, exts:str|list=None,
)->list:
    "Find files (optionally, also directories) based on file names"
