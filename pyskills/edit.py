"""Functions for creating, reading, and modifying files. Each editing operation returns unified diffs showing what changed, or `"none: No changes."`, or `"error: ..."`.
...
# %% auto #0
__all__ = ['file_insert_line', 'file_str_replace', 'file_strs_replace', 'file_replace_lines', 'file_del_lines', 'file_edit',
...
allow(file_insert_line, file_str_replace, file_strs_replace, file_replace_lines, file_del_lines, file_create, allow_policy=_wp)
