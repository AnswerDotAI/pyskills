"""Functions for modifying files. Each editing operation returns unified diffs showing what changed, or `"none: No changes."`, or `"error: ..."`.
...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_edit.ipynb.
