...
- Add folder-local PYSKILLs discovery via `enable_local_skills`; improve doc/xdir rendering of classes, instances and dynamic APIs ([#57](https://github.com/AnswerDotAI/pyskills/issues/57))
